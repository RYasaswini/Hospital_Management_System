...
public class AdminHomePage extends JFrame implements ActionListener {
    ...
    AdminHomePage(String adminname, String admin_id, int login_id, String username) {
        ...
        login__id = login_id;
        username2 = username;
        String imgUrl="Hospital/Icons/adminhome.jpg";
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource(imgUrl));
    ...
    public static void main(String[] args) {
        new AdminHomePage("admin", "1", 1, "admin").setVisible(true);
    }
}
