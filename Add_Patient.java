...
public class Add_Patient implements ActionListener {
    ...
    Add_Patient() {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Hospital/Icons/patient.jpg"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            try {
                ...
                String q = "INSERT INTO patient (pat_id, name, username, password, email, father_name, phone, material_status, city, gender, blood, age, dob, deceased, address) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
