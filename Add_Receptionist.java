    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            try {
                ...
                String q = "INSERT INTO receptionist VALUES ('" + res_id + "', '" + name + "', '" + username + "', '" + password + "', '" + email + "', '" + father_name + "', '" + phone + "', '" + qualification + "', '" + city + "', '" + gender + "', '" + blood + "', '" + age + "', '" + dob + "', '" + joining_date + "', '" + address + "')";
